...
global file_types
file_types = ['doc', 'docx', 'docm', 'dot', 'dotx', 'dotm','ppt', 'pptx', 'pps', 'ppsx', 'ppsm', 'pptm', 'potm', 'pot','csv', 'pdf', 'xls', 'xlsx', 'xslsm', 'xlt', 'xltx', 'xltm', 'sql', 'txt']
global user_agents
...
def banner():
    ...
    print('                            Version 2.20                              ')
    print('                       A project by                           ')
    print('SpecialL Thanks To: Love Side Inside    ') 
    print('Garnesia Team    ')
    print('Aceh About Hacked World    ')
    print('Legion7 Hacker Team    ')
    print('3EXPLOIT.ID    ')       
    print('INDOS666Gh0sT Sec |Revolutions    ') 
    print('GreyHat Sec666 Gh0sT    ')
    print('Security Agency_X7    ') 
    print('ICC TEAM    ') 
    print('Hacktivis Indonesia    ')
    print('ANONYMOUS INDONESIA | Revolutions    ')
    print('                  python3 Dump.py -h to start 
          ' + Style.RESET_ALL)
    print("-" * 73)
